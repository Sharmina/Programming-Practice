	...
	private void printQuakes() 
	{
		// TODO: Implement this method
		 ...
		 for(Marker quake: quakeMarkers)
		 {
			 ...
			 EarthquakeMarker pm=(EarthquakeMarker)quake;
			 if(pm.isOnLand)
			 {
			 	String countryName=pm.getStringProperty("country");
				System.out.println(pm.getProperties().toString());
				System.out.println(countryName);
				 if(hm.containsKey(countryName))
				 {
					 hm.put(countryName, hm.get(countryName)+1);
					 //System.out.println("found");
					 
				 }
				 else
				 {
					 hm.put(countryName,1);
		 ...
		 Enumeration<String> items = hm.keys();
		 
		 while(items.hasMoreElements()){
		 
			 String countryName=items.nextElement();
			 System.out.println(countryName+"::"+hm.get(countryName));
		 }
