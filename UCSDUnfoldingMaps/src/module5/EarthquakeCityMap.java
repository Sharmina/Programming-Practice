...
public class EarthquakeCityMap extends PApplet {
	...
	private void selectMarkerIfHover(List<Marker> markers)
	{
		...
		{
			if(((AbstractMarker)marker).isInside(map, mouseX, mouseY))
			{
	...
	private void selectMarkerIfClicked(List<Marker> markers)
	{
		...
		for(Marker marker:markers)
		{
			if(((AbstractMarker)marker).isInside(map, mouseX, mouseY))
			{
				...
				{
					System.out.println("City marker clicked.");
					for(Marker m:quakeMarkers)
					{
						EarthquakeMarker eq=(EarthquakeMarker)m;
						
						if(lastClicked.getDistanceTo(m.getLocation())<=eq.threatCircle())
						{
							m.setHidden(false);
						}
						else
				...
				{
					System.out.println("Earthquake marker clicked.");
					for(Marker city:cityMarkers)
					{
						EarthquakeMarker eq=(EarthquakeMarker)marker;
						
						if(city.getDistanceTo(eq.getLocation())<=eq.threatCircle())
						{
